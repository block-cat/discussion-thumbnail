...
/* harmony import */ var object_assign_auto__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! object.assign/auto */ "./node_modules/object.assign/auto.js");
/* harmony import */ var object_assign_auto__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(object_assign_auto__WEBPACK_IMPORTED_MODULE_5__);
...
var DiscussionThumbnail = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    attrs.style.position = 'relative'; // Added by BlockCat

    attrs.style.objectFit = 'cover'; // Finish adding
    ...
    if (this.attrs.src.includes('imgur')) {
      var image_url = this.attrs.src;
      var image_prefix = image_url.substring(0, image_url.lastIndexOf("."));
      var image_sufix = image_url.substring(image_url.lastIndexOf("."));
    ...
    return m("div", {
      className: flarum_common_utils_classList__WEBPACK_IMPORTED_MODULE_4___default()(attrs.className, 'DiscussionListItem-thumbnail')
...
/* harmony import */ var _components_DiscussionThumbnail__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/DiscussionThumbnail */ "./src/forum/components/DiscussionThumbnail.js");
...
app.initializers.add('block-cat/discussion-thumbnail', function () {
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_components_DiscussionListItem__WEBPACK_IMPORTED_MODULE_4___default.a.prototype, 'view', function (vdom) {
    ...
    var tooltip = content.children.find(function (e) {
      return e.tag && e.tag === flarum_common_components_Tooltip__WEBPACK_IMPORTED_MODULE_5___default.a;
    });
    var author = find(tooltip, 'DiscussionListItem-author');
    var avatar = find(author, 'Avatar');
    if (!avatar) return;
    delete avatar.attrs.src;
    author.children[author.children.indexOf(avatar)] = m(_components_DiscussionThumbnail__WEBPACK_IMPORTED_MODULE_6__["default"], {
